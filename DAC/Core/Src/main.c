...
uint8_t waveform = TRIANGLE;  // Mặc định là sóng sin

// LUT dạng sóng (32 mẫu)
...
const uint8_t square_wave[32] = {255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
...
int main(void) {
    ...
    while (1) {
        // Đọc nút nhấn (PB0, PB1, PB2)
//        if (!(GPIOB->IDR & GPIO_IDR_ID0)) waveform = SIN;
//        if (!(GPIOB->IDR & GPIO_IDR_ID1)) waveform = SQUARE;
